...
public class StockData {
    ...
    public static <T> List<T> extract(List<StockData> stockDataList, java.util.function.Function<StockData, T> mapper) {
        return stockDataList.stream().map(mapper).collect(Collectors.toList());
    }
}